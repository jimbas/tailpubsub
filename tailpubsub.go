...
// run:
//   export GOOGLE_APPLICATION_CREDENTIALS='/home/USER/lib/service-account.json' 
//   ./tailpubsub -batchsize=1 -project="dataengineering-351211" -topic="mypg.public.debezium-test" -subscription="mypg.public.debezium-test-sub"
...
var (
	...
	subscription = flag.String("subscription", "", "PUB/SUB subscription name")
...
func main() {
	...
	fullSubscriptionName := fmt.Sprintf("projects/%v/subscriptions/%v", *project, *subscription)
